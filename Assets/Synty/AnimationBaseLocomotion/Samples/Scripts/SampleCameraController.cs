...
namespace Synty.AnimationBaseLocomotion.Samples
{
    public class SampleCameraController : MonoBehaviour
    {
        ...
        [SerializeField]
        private float _cameraTiltOffset; // Eskisi gibi dursun, uyumluluk için
        [SerializeField]
        ...
        [SerializeField]
        private float _cameraPitchOffset = 0f;   // X ekseni (aþaðý/yukarý)
        [SerializeField]
        private float _cameraYawOffset = 0f;     // Y ekseni (saða/sola)
        [SerializeField]
        private float _cameraRollOffset = 0f;    // Z ekseni (eðilme)
        ...
        // Offsetlerle kameranýn lokal rotasyonunu ayarla
        private void SetCameraRotation()
        {
            // _cameraTiltOffset legacy için dursun, istersen silebilirsin
