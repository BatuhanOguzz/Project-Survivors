...
namespace Synty.AnimationBaseLocomotion.Samples
{
    public class SamplePlayerAnimationController : MonoBehaviour
    {
        ...
        private float attackInterval = 1f; // Saniyede bir saldırı
        ...
        // H�z art�r�c� kartlar i�in:
        public void IncreaseWalkSpeed(float amount)
        {
            _walkSpeed += amount;
            Debug.Log("Walk speed artt�! Yeni walk speed: " + _walkSpeed);
        }

        public void IncreaseSprintSpeed(float amount)
        {
            _sprintSpeed += amount;
            Debug.Log("Sprint speed artt�! Yeni sprint speed: " + _sprintSpeed);
        }

        // Attack speed kart� i�in:
        public void IncreaseAttackSpeed(float percent)
        {
            ...
            Debug.Log("Attack animasyon h�z� ayarland�: " + newAttackSpeed);
        }
